...
```gradle
implementation 'com.mikepenz:fastadapter:3.2.1@aar'
...
```gradle
implementation 'com.mikepenz:fastadapter-commons:3.2.1@aar'
```

Expandable support is included and can be added via this
```gradle
implementation 'com.mikepenz:fastadapter-extensions-expandable:3.2.1@aar'
...
```gradle
implementation 'com.mikepenz:fastadapter-extensions:3.2.1@aar'
