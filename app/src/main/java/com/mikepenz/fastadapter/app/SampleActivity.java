    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mResult = new DrawerBuilder()
                ...
                /*.addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(R.string.sample_radiobutton_item).withDescription(R.string.sample_radiobutton_item_descr).withSelectable(false).withIdentifier(11).withIcon(CommunityMaterial.Icon2.cmd_radiobox_marked),
