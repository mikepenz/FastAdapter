 ...
 */
public class GenericHeaderItem extends GenericAbstractItem<HeaderIconModel, GenericHeaderItem, GenericHeaderItem.ViewHolder> {
    //the static ViewHolderFactory which will be used to generate the ViewHolder for this Item
    private static final ViewHolderFactory<? extends ViewHolder> FACTORY = new ItemFactory();

    public GenericHeaderItem(HeaderIconModel icon) {
        super(icon);
    }
    ...
    public void bindView(ViewHolder viewHolder, List payloads) {
        ...
        viewHolder.image.setBackgroundColor(Color.RED);
    }
