...
abstract class ClickEventHook<Item : GenericItem> : EventHook<Item> {
    abstract fun onClick(v: View, position: Int, fastAdapter: IFastAdapter<Item>, item: Item)
}
 ...
 * }
 */
inline fun <reified VH : RecyclerView.ViewHolder, reified Item : GenericItem> IFastAdapter<Item>.addClickListener(crossinline resolveView: (VH) -> View?, crossinline resolveViews: ((VH) -> List<View>?) = { null }, crossinline onClick: (v: View, position: Int, fastAdapter: IFastAdapter<Item>, item: Item) -> Unit) {
