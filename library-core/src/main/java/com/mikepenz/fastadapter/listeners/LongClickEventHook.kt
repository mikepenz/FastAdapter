 ...
 */
inline fun <reified VH : RecyclerView.ViewHolder, reified Item : GenericItem> FastAdapter<GenericItem>.addLongClickListener(crossinline resolveView: (VH) -> View?, crossinline resolveViews: ((VH) -> List<View>?) = { null }, crossinline onLongClick: (v: View, position: Int, fastAdapter: FastAdapter<Item>, item: Item) -> Boolean) {
